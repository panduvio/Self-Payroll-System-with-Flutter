...
abstract class $CompanyModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int company_id, String name, int balance});
}
...
class _$CompanyModelImpl implements _CompanyModel {
  _$CompanyModelImpl(
      {required this.company_id, required this.name, required this.balance});
  ...
  @override
  String toString() {
    return 'CompanyModel(company_id: $company_id, name: $name, balance: $balance)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, company_id, name, balance);
...
abstract class _CompanyModel implements CompanyModel {
  factory _CompanyModel(
      ...
      required final int balance}) = _$CompanyModelImpl;
