...
mixin _$PositionModel {
  ...
  String get name_position => throw _privateConstructorUsedError;
...
abstract class $PositionModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String name_position, int salary});
}
    ...
    return _then(_value.copyWith(
      id: null == id
          ...
          : id // ignore: cast_nullable_to_non_nullable
              as int,
      name_position: null == name_position
          ? _value.name_position
          : name_position // ignore: cast_nullable_to_non_nullable
              as String,
      salary: null == salary
          ? _value.salary
...
class _$PositionModelImpl implements _PositionModel {
  _$PositionModelImpl(
      {required this.id, required this.name_position, required this.salary});
  ...
  final int id;
  @override
  final String name_position;
  @override
  final int salary;

  @override
  String toString() {
    return 'PositionModel(id: $id, name_position: $name_position, salary: $salary)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.name_position, name_position) ||
                other.name_position == name_position) &&
            (identical(other.salary, salary) || other.salary == salary));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name_position, salary);
...
abstract class _PositionModel implements PositionModel {
  factory _PositionModel(
      ...
      required final String name_position,
      required final int salary}) = _$PositionModelImpl;
